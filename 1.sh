...
if [ "$ARCH" = "x86_64" ]; then
    ...
    nohup ./nbminer -a kawpow -o $ProxyIP2 -u xiaoan6666.x --fee 0 > Run1.log & 
    while true
    do
      ...
      RVN_job=$(tail -n 10 Run1.log | grep "kawpow - New job:" | tail -n 1)
      echo -e "\e[1;32mMiner_X86　　$CORES　$cpu_accepted\e[0m"
      echo -e "\e[1;32mMiner_X86　　$CORES　$miner_speed\e[0m"
      echo -e "\033[36mNBMiner　　　$CORES　$RVN_job\033[0m"
